$(document)
    .ready(function() {
        ...
        clickAsc = function clickAsc() {
            if($('[value="asc"]:checked').length === 0) {

                $('#asc').removeClass('not-active');
                $('#asc').addClass('active');

                $('#desc').removeClass('active');
                $('#desc').addClass('not-active');

                $('#ordemAsc').click();
            }
        }
        clickDesc = function clickDesc() {
            if($('[value="desc"]:checked').length === 0) {

                $('#desc').removeClass('not-active');
                $('#desc').addClass('active');

                $('#asc').removeClass('active');
                $('#asc').addClass('not-active');
